/* The format is HEX & NAME in a map */
export type hexAndNameMap = Map<string, string>

export const _hexAndColor: hexAndNameMap = new Map([
  ['000000', 'Black'],
  ['000080', 'Navy Blue'],
  ['0000C8', 'Dark Blue'],
  ['0000FF', 'Blue'],
