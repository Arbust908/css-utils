...
const ntc = {
  ...
  hsl(color) {
    const rgb = [Number.parseInt(`0x${color.substring(1, 3)}`) / 255, Number.parseInt(`0x${color.substring(3, 5)}`) / 255, Number.parseInt(`0x${color.substring(5, 7)}`) / 255]
    let h, s
    const r = rgb[0]; const g = rgb[1]; const b = rgb[2]
    ...
    return [Number.parseInt(h * 255), Number.parseInt(s * 255), Number.parseInt(l * 255)]
  },

  // adopted from: Farbtastic 1.2
  // http://acko.net/dev/farbtastic
  rgb(color) {
    return [Number.parseInt(`0x${color.substring(1, 3)}`), Number.parseInt(`0x${color.substring(3, 5)}`), Number.parseInt(`0x${color.substring(5, 7)}`)]
  },
