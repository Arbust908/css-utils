...
onMounted(() => {
  ...
  *,::after,::before { box-sizing:inherit }
  ...
  ::placeholder{color:inherit;opacity:.25}
  ::-moz-focus-inner{border:0;padding:0}
  html{height:100%}
  .body{background:#f8f8f8;color:#222;font-family:niveau-grotesk,sans-serif;font-style:normal;font-size:14px;height:100%;margin:0}
  ::placeholder{color:#555;font-size:15px;font-weight:400;opacity:1}
  a{text-decoration:none;color:#028f00}
  h1{font-size:30px}
  h1{font-family:prometo,sans-serif;margin-bottom:30px;line-height:normal;font-weight:500}
